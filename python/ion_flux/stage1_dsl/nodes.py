import re
from typing import Dict, Any, Union, Optional, TypedDict, TYPE_CHECKING

if TYPE_CHECKING:
    from .spatial import Domain
...
class Scalar(Node):
    ...
    def to_dict(self, tags: Optional[Dict[int, str]] = None) -> Dict[str, Any]: return {"type": "Scalar", "value": self.value}
...
class Parameter(Node):
    ...
    def __init__(self, default: float, name: str = ""):
        ...
        self.name = validate_identifier(name)
    def to_dict(self, tags: Optional[Dict[int, str]] = None) -> Dict[str, Any]: return {"type": "Parameter", "name": self.name, "default": self.default}
...
class BinaryOp(Node):
    ...
    def to_dict(self, tags: Optional[Dict[int, str]] = None) -> Dict[str, Any]: 
        d = {"type": "BinaryOp", "op": self.op, "left": self.left_node.to_dict(tags), "right": self.right_node.to_dict(tags)}
        if tags and id(self) in tags: d["_bc_id"] = tags[id(self)]
        return d
...
class UnaryOp(Node):
    ...
    def to_dict(self, tags: Optional[Dict[int, str]] = None) -> Dict[str, Any]: 
        d = {"type": "UnaryOp", "op": self.op, "child": self.child.to_dict(tags)}
        ...
        return {
            ...
            "regions": [
                {"domain": d.name, "start_idx": getattr(d, "start_idx", 0), 
                 "end_idx": getattr(d, "start_idx", 0) + d.resolution, "eq": eq.to_dict(tags)}
...
class Boundary(Node):
    ...
    def to_dict(self, tags: Optional[Dict[int, str]] = None) -> Dict[str, Any]: 
        d = {"type": "Boundary", "side": self.side, "child": self.child.to_dict(tags)}
...
class InitialCondition(Node):
    ...
    def to_dict(self, tags: Optional[Dict[int, str]] = None) -> Dict[str, Any]: return {"type": "InitialCondition", "child": self.child.to_dict(tags)}
